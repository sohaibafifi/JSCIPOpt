...
public class Scip
{
   ...
   public void chgVarObj(Variable var,  double newobj){
      CHECK_RETCODE(SCIPJNI.SCIPchgVarObj(_scipptr,  var.getPtr(),  newobj));
   }
  ...
  public double getLowerbound() {
      return SCIPJNI.SCIPgetLowerbound(_scipptr);
  }
